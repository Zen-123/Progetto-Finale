...
void Player::logOutput(const std::string& txt) {
...
void Player::checkPurchaseSquare(std::string board[9][9], EconomicSquare& E,StandardSquare& S, LuxurySquare& L ){
...
void Player::checkPurchaseHouse( std::string board[9][9], EconomicSquare& E,StandardSquare& S, LuxurySquare& L){
...
void Player::checkPurchaseHotel( std::string board[9][9], EconomicSquare& E,StandardSquare& S, LuxurySquare& L){
...
bool ComputerPlayer::randomChoice(){
